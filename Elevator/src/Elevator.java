...
public class Elevator extends JPanel implements ActionListener
{
  ...
  public void setFloor(int f) {
  	...
  	boolean x = floorBits[1];
  	boolean y = floorBits[0];
  	boolean fl = buttons[0];
  	...
  	// Problem 4:
  	doorOpen = x && (y && t || s && !y) || (fl && y && !x);

  	// Problem 5:
  	direction[0] = (!fl && s && !x) || (!fl && t && !x) || (!fl && !s && !y && t);
  	direction[1] = (!s && !y && (t || fl)) || (!x && !fl && (s || t)) || (y && !t && (x && fl || (!fl && s)));


  	// Problem 6:
  	lightUp = !x || !fl && !y && (t || s);
  	lightDown = x && (fl || y || !t && !s);
